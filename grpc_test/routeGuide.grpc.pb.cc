...
static const char* RouteGuide_method_names[] = {
  "/routeguide.RouteGuide/GetFuture",
...
RouteGuide::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_GetFuture_(RouteGuide_method_names[0], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status RouteGuide::Stub::GetFuture(::grpc::ClientContext* context, const ::routeguide::Point& request, ::routeguide::Point* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_GetFuture_, context, request, response);
}

void RouteGuide::Stub::experimental_async::GetFuture(::grpc::ClientContext* context, const ::routeguide::Point* request, ::routeguide::Point* response, std::function<void(::grpc::Status)> f) {
  return ::grpc::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_GetFuture_, context, request, response, std::move(f));
}

::grpc::ClientAsyncResponseReader< ::routeguide::Point>* RouteGuide::Stub::AsyncGetFutureRaw(::grpc::ClientContext* context, const ::routeguide::Point& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::routeguide::Point>::Create(channel_.get(), cq, rpcmethod_GetFuture_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::routeguide::Point>* RouteGuide::Stub::PrepareAsyncGetFutureRaw(::grpc::ClientContext* context, const ::routeguide::Point& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderFactory< ::routeguide::Point>::Create(channel_.get(), cq, rpcmethod_GetFuture_, context, request, false);
}
...
RouteGuide::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< RouteGuide::Service, ::routeguide::Point, ::routeguide::Point>(
          std::mem_fn(&RouteGuide::Service::GetFuture), this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status RouteGuide::Service::GetFuture(::grpc::ServerContext* context, const ::routeguide::Point* request, ::routeguide::Point* response) {
  (void) context;
  (void) request;
  (void) response;
