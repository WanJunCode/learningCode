...
#ifndef PROTOBUF_INCLUDED_routeGuide_2eproto
#define PROTOBUF_INCLUDED_routeGuide_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_routeGuide_2eproto 
...
class Point : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:routeguide.Point) */ {
 public:
  ...
  // int32 longtitudde = 2;
  void clear_longtitudde();
  static const int kLongtituddeFieldNumber = 2;
  ::google::protobuf::int32 longtitudde() const;
  void set_longtitudde(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 longtitudde_;
...
// int32 longtitudde = 2;
inline void Point::clear_longtitudde() {
  longtitudde_ = 0;
}
inline ::google::protobuf::int32 Point::longtitudde() const {
  // @@protoc_insertion_point(field_get:routeguide.Point.longtitudde)
  return longtitudde_;
}
inline void Point::set_longtitudde(::google::protobuf::int32 value) {
  
  longtitudde_ = value;
  // @@protoc_insertion_point(field_set:routeguide.Point.longtitudde)
}
...
#endif  // PROTOBUF_INCLUDED_routeGuide_2eproto
